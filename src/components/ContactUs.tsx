            ...
            <div>
              ...
              <div className="mt-6 flex flex-wrap items-center gap-3">
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2.5 px-4 py-2.5 text-white font-semibold rounded-lg shadow-sm transition-all transform hover:shadow-md hover:-translate-y-0.5 bg-blue-600 hover:bg-blue-700 text-sm"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group inline-flex items-center justify-center gap-2.5 px-4 py-2.5 text-gray-700 font-semibold rounded-lg shadow-sm transition-all transform hover:shadow-md hover:-translate-y-0.5 bg-gray-100 hover:bg-gray-200 text-sm"
                >
