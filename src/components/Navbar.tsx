        ...
        <div className="flex items-center justify-between h-20 sm:h-24 gap-4">
          ...
          <div className="flex items-center justify-end flex-1 min-w-0">
            ...
            <nav className="hidden sm:flex items-center gap-4 sm:gap-6 md:gap-8">
              {navLinks.map((link) => (
                <a key={link.name} href={link.href} className="text-sm font-medium text-gray-600 hover:text-emerald-600 transition-colors flex-shrink-0 last:pr-2">
                  {link.name}
                </a>
              ))}
            </nav>
            ...
            <div className="flex items-center flex-shrink-0 gap-1">
              ...
              <a href="https://www.facebook.com/profile.php?id=61586918030050" target="_blank" rel="noopener noreferrer" className="p-2 rounded-full text-gray-500 hover:bg-gray-100 transition-colors" aria-label="Facebook">
              ...
              <a href="https://www.instagram.com/thepaddledepot/" target="_blank" rel="noopener noreferrer" className="p-2 rounded-full text-gray-500 hover:bg-gray-100 transition-colors" aria-label="Instagram">
