export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-sm border-b border-gray-200/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          {/* Logo */}
          <div className="flex-shrink-0 flex items-center gap-2">
            <img src="/paddle-depot-logo.png" alt="Paddle Depot Logo" className="w-8 h-8" />
            <span className="text-xl font-bold text-gray-900">Paddle Depot</span>
          </div>

          {/* Desktop Search */}
          <div className="hidden md:flex flex-1 justify-center px-6"></div>
          ...
          <div className="hidden md:flex items-center gap-3">
            <a
              ...
              className="p-2 rounded-full text-gray-400 hover:text-blue-600 hover:bg-gray-100 transition-colors"
              aria-label="Facebook"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="p-2 rounded-full text-gray-400 hover:text-pink-600 hover:bg-gray-100 transition-colors"
