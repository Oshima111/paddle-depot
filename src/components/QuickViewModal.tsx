          ...
          <div className="mt-8 pt-6 border-t">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <a
                ...
                className="inline-flex items-center gap-2 px-4 py-2 text-sm text-white font-semibold rounded-lg shadow-sm transition-colors bg-blue-600 hover:bg-blue-700"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-4 py-2 text-sm text-white font-semibold rounded-lg shadow-sm transition-colors bg-pink-600 hover:bg-pink-700"
              >
