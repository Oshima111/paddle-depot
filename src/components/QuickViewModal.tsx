          ...
          <div className="mt-8 pt-6 border-t">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a
                ...
                className="inline-flex items-center justify-center gap-2.5 px-5 py-3 text-sm font-medium text-gray-700 rounded-xl border border-gray-200 bg-white transition-all duration-200 hover:bg-gray-50 hover:border-gray-300 hover:shadow-md hover:scale-[1.02] active:scale-[0.98]"
              >
                <svg className="w-5 h-5 text-[#1877F2] shrink-0" fill="currentColor" viewBox="0 0 24 24"><path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.772-1.63 1.563V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" /></svg>
                Message on Facebook
              </a>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group inline-flex items-center justify-center gap-2.5 px-5 py-3 text-sm font-medium text-gray-700 rounded-xl border border-gray-200 bg-white transition-all duration-200 hover:bg-gray-50 hover:border-gray-300 hover:shadow-md hover:scale-[1.02] active:scale-[0.98]"
              >
                <svg className="w-5 h-5 shrink-0 text-gray-400 group-hover:text-pink-500 transition-colors" fill="currentColor" viewBox="0 0 24 24">
